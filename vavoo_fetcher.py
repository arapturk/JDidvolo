...
def fetch_vavoo_channels():
    # GitHub Actions ortamında sorunsuz çalışan küresel Vavoo kaynak havuzu
    ...
    try:
        ...
        with open("vavoo_all_channels.m3u", "w", encoding="utf-8") as main_file:
            ...
            for line in lines:
                ...
                if line.startswith("#EXTINF:"):
                    ...
                    # Split hatası düzeltildi (parts[1] indisi eklendi)
        ...
        # Gerçek bir hata durumunda GitHub Actions loglarında görünmesi için hata fırlatıyoruz
        raise e
